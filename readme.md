...
Это реализация трехмерной игры "Четыре в ряд" (по аналогии с настольной игрой Giiker Smart Four) на игровом движке Godot Engine. Доска имеет размер 5x5x5, и цель игры — собрать четыре фишки подряд в любом направлении (горизонтальном, вертикальном, плоскостном или пространственном диагональном).
...
| `res://Materials/` | Материалы для фишек и доски (`black_Material.tres`, `White_Material.tres`). |
<!-- | `res://Assets/` | 3D-модели, текстуры, шрифты. | -->

## 🕹️ Руководство по Игре

* **Камера:** Поворачивайте камеру с помощью клавиш **Q** и **E** 
<!-- (или другого назначенного ввода). -->
